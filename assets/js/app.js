      ...
      if ($.AdminLTE.options.sidebarSlimScroll) {
        if (typeof $.fn.slimScroll != 'undefined') {
          ...
          $(".sidebar").slimscroll({
            ...
            color: "rgba(155, 164, 169, 0.682353)",
            size: "5px"
          });
        }
      }
...
$(function(){
  if($('.breadcrumb li').length > 1){
    ...
    $('.sidebar-menu > li > a').filter(function() {
      ...
      $('.sidebar-menu > li > ul > li > a').filter(function() {
          var text = $(this).text().replace(/ /g,''); 
      ...
      $('.sidebar-menu > li > ul > li > ul > li > a').filter(function() {
          var text = $(this).text().replace(/ /g,''); 
          return (text == third);
      }).parent().addClass('active').parents('li').addClass('active').children('ul').show();

  }else{
    $('.sidebar-menu > li > a').parent().eq(0).addClass('active');
  }
